        ...
        messages=[
            {
                "role": "system",
                "content": (
                    "You are an AI assistant that answers PDF questions. "
                    "If the user asks for YouTube videos, respond with clickable search links."
                )
            },
            {
                "role": "user",
                "content": f"Answer questions about this PDF: {single_pdf.pdf_chunked_text}"
            },
            {
                "role": "user",
